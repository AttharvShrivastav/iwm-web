        ...
        <div className="max-w-md w-full text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-zinc-600 font-sans text-lg">
              Thank you for your interest in joining IWM. Our team will review
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="relative group">
                  ...
                  <div
                    ...
                    } p-12 transition-all flex flex-col items-center justify-center gap-4 text-center`}
                  >
                    {resume ? (
                      <>
            ...
            {selectedJob ? (
              <>
                <div className="flex flex-col gap-6">
                  ...
                  <h3 className="text-3xl font-medium text-black font-agrandir">
                    {selectedJob.title}
                  </h3>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <ul className="flex flex-col gap-3">
                        {selectedJob.details.map((detail, i) => (
                          <li
                            key={i}
                            className="flex gap-3 text-zinc-600 font-sans leading-relaxed"
                          >
                ...
                <div className="pt-8 border-t border-zinc-200">
                  <p className="text-zinc-400 text-xs font-sans leading-relaxed">
                    IWM is an equal opportunity employer. We celebrate diversity
                    and are committed to creating an inclusive environment for
                    all employees.
                  </p>
                </div>
              </>
              ...
              <div className="flex flex-col gap-6 text-center py-20">
                <SectionHeader
                  ...
                  className="text-black/60 mx-auto"
                />

                <h3 className="text-2xl font-medium text-black font-agrandir">
                  Join Our Talent Pool
                </h3>

                <p className="text-zinc-600 font-sans leading-relaxed">
                  Don't see a specific role that fits? Apply anyway! We're
                  always looking for passionate individuals to join our mission
                  for cleaner cities.
                </p>
              </div>
            )}
